...
var _user$project$App$containerStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'background-color', _1: 'rgb(88, 211, 216)'},
			{ctor: '_Tuple2', _0: 'padding', _1: '1rem'}
		]));
var _user$project$App$visibility = function (predicate) {
	return predicate ? {ctor: '_Tuple2', _0: 'display', _1: 'block'} : {ctor: '_Tuple2', _0: 'display', _1: 'none'};
};
...
var _user$project$App$modelToValue = function (model) {
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'count',
				_1: _elm_lang$core$Json_Encode$int(model.count)
			},
				{
				ctor: '_Tuple2',
				_0: 'text',
				...
				ctor: '_Tuple2',
				_0: 'showText',
				_1: _elm_lang$core$Json_Encode$bool(model.showText)
			}
			]));
};
var _user$project$App$encodeModel = function (model) {
	return A2(
...
var _user$project$App$storeAndReturn = function (model) {
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		model,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$App$saveStateToLocalStorage(
...
var _user$project$App$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Increment':
				return _user$project$App$storeAndReturn(
					_elm_lang$core$Native_Utils.update(
						model,
						{count: model.count + 1}));
			case 'Decrement':
				var _p1 = model.count;
				if (_p1 === 0) {
					return _user$project$App$storeAndReturn(model);
				} else {
					return _user$project$App$storeAndReturn(
						_elm_lang$core$Native_Utils.update(
							model,
			...
			case 'TextChange':
				return _user$project$App$storeAndReturn(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							text: _elm_lang$core$String$reverse(_p0._0)
						}));
			case 'ToggleCheckBox':
				return _user$project$App$storeAndReturn(
					_elm_lang$core$Native_Utils.update(
...
var _user$project$App$personDecoder = A3(
	...
	A3(
		...
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$App$Person)));
var _user$project$App$peopleDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	_elm_lang$core$Native_List.fromArray(
		['data']),
...
var _user$project$App$GetPeopleFailure = function (a) {
	return {ctor: 'GetPeopleFailure', _0: a};
};
var _user$project$App$getPeople = A3(
	_elm_lang$core$Task$perform,
	_user$project$App$GetPeopleFailure,
	_user$project$App$GetPeopleSuccess,
	A2(_evancz$elm_http$Http$get, _user$project$App$peopleDecoder, 'http://localhost:8888/people'));
var _user$project$App$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$App$initialModel,
	_elm_lang$core$Native_List.fromArray(
		[_user$project$App$getPeople]));
var _user$project$App$ToggleCheckBox = function (a) {
	return {ctor: 'ToggleCheckBox', _0: a};
};
var _user$project$App$TextChange = function (a) {
	return {ctor: 'TextChange', _0: a};
};
var _user$project$App$Decrement = {ctor: 'Decrement'};
var _user$project$App$Increment = {ctor: 'Increment'};
var _user$project$App$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$App$containerStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				_elm_lang$html$Html$div,
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$App$Decrement)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('-')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Toggle Showing Text Output')
							])),
						A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_user$project$App$visibility(model.showText)
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onInput(_user$project$App$TextChange)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Http Request: ')
							])),
						A2(
